function [Data] = cargaBatDefault(Data, Baterias)
    ...
    for i =1:length(Baterias)
			fields = {...
				'cv','cr','epsilon','etaC','etaD','pgTop','pgLow','sTop','ETop', ...
				'ELow','EPref','beta','wU','wOm','m1','m2','m3','kapa','gama'...
				};
			...
			Data.St.Bat.etaC(Baterias(i).nod) = S.etaC;
			Data.St.Bat.etaD(Baterias(i).nod) = 1/S.etaD;
			...
			Data.St.Bat.EPref(Baterias(i).nod) = S.EPref;
