function [Data] = Dfig_200kw(Data, windNodes, P_mec, n_)
...
if ~isempty(windNodes)
    ...
    Data.Gen.DFIG.P_mec(windNodes,:) = repmat(P_mec, [length(windNodes) 1]);
    Data.Gen.DFIG.n_(windNodes,:) = repmat(n_, [length(windNodes) 1]);
