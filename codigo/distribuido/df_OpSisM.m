...
cvx_begin quiet
	...
	tfopt_conv = ...
        1/(2*DistrInfo.Gama_m) * norms(pN - DistrInfo.OpSis.pN,2,1) ...
        + 1/(2*DistrInfo.Gama_l) * norms(qN - DistrInfo.OpSis.qN,2,1) ...
        + 1/(2*DistrInfo.Gama_l) * norms(qCp - DistrInfo.OpSis.qCp,2,1);
